...
if __name__ == "__main__":
    config = GPTHifiganConfig(
        ...
        data_path="GJ_latents/wavs",
        mel_path="GJ_latents/gpt_latents",
        spk_path ="GJ_latents/speaker_embeddings",
        output_path="outputs",
        pretrain_path="checkpoints/GPT_XTTS_FT-May-23-2025_01+20PM-8e59ec3/checkpoint_15000.pth",
